...
- Ако имате по-малко от 25 възложените лицензи, можете да прекратите абонамента си онлайн. Отидете на [Фактуриране](https://support.office.com/article/https://portal.office.com/adminportal/home.aspx#/subscriptions) \> **абонаменти**и след това изберете **още действия** \> **Отмени абонамент**.
