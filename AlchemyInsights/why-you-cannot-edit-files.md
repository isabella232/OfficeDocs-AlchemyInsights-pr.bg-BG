...
Ако имате библиотеки с **плащане, изисква** или **проверка** колони или метаданни, или когато **чернова на защитата** е зададена или **само потребители, които могат да редактират** или **само потребители, които могат да одобрят елементи** в настройките на версията на Библиотека:
