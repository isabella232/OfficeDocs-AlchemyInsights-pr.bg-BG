...
---
# <a name="sharing-and-permission-methods-to-provide-or-restrict-user-access-to-sharepoint-site"></a>Споделяне и методи за разрешение за предоставяне или ограничаване на потребителския достъп до сайта на SharePoint

След като сте създали сайт на SharePoint, може да поискате да предоставите или ограничите потребителския достъп до сайта или неговото съдържание. Това може да стане чрез различни методи за споделяне и разрешение, отбелязани по-долу.
...
- [Промяна на типа на връзката по подразбиране, когато потребителите получават връзки за споделяне](https://docs.microsoft.com/sharepoint/change-default-sharing-link)
