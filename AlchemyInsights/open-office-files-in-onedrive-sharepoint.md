...
Ако имате проблеми с отварянето Office файлове и документи от библиотеки с SharePoint или OneDrive документи, ето някои предложения, които да ви помогнат да ги коригирате.
...
- [Изтегляне и проверка за повреда на файлове на вашия локален компютър](https://support.office.com/article/How-to-recover-missing-deleted-or-corrupted-items-in-SharePoint-Online-and-OneDrive-for-Business-3d748edf-c072-46c9-81a4-4989056ebc87[])
...
За повече информация или подробности проверете статията Коригиране на [проблеми при отваряне на документи SharePoint библиотеки](https://support.office.com/article/Fix-problems-opening-documents-in-SharePoint-libraries-31329FA1-4AD0-47FC-95D8-BB0C5B12A536)
