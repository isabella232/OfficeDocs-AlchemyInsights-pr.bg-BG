...
ms.locfileid: "47700588"
---
# <a name="external-contact-is-unable-to-accept-a-sharepoint-invitation"></a>Външният контакт не може да приеме покана от SharePoint

Ако външните не могат да приемат покана за споделяне, моля, опитайте да посетите връзките по-долу.
...
- [Грешки при споделяне в SharePoint и OneDrive](https://docs.microsoft.com/sharepoint/sharepoint-onedrive-error-message)
