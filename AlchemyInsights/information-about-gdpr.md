...
- Информация за **Субекта заявки** (DSR) - Открийте, достъп, поправяне, ограничават, изтриване, износ е [тук.](https://docs.microsoft.com/en-us/microsoft-365/compliance/gdpr-dsr-office365)
    
- Информация за **Неправомерно** е [тук.](https://servicetrust.microsoft.com/ViewPage/GDPRBreach)
    
- Информация за **местоположения на данни** е [тук.](https://products.office.com/en-us/where-is-your-data-located?ms.officeurl=datamaps&amp;geo=All#All)
