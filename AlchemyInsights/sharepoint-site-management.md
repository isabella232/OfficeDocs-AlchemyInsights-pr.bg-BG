...
---
# <a name="sharepoint-online-site-management"></a>Управление на сайтове на SharePoint Online

Ето някои често изисквани теми за управление на sharePoint Online сайт:

- [Управление на сайтове](https://docs.microsoft.com/sharepoint/manage-sites-in-new-admin-center)
- [Управление на ограниченията за съхранение на сайта](https://docs.microsoft.com/sharepoint/manage-site-collection-storage-limits)
