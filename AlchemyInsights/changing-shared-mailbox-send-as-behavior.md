...
Ако искате всички членове да видите изпратеното имейл, в центъра за администриране на Microsoft 365, редактирайте данните за споделената пощенска кутия и изберете **изпратени** \> **Редактиране**.
