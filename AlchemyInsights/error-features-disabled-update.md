...
---
# <a name="error-most-of-the-features-have-been-disabled-because-this-product-requires-an-update"></a>Грешка: повечето функции са забранени, тъй като този продукт изисква актуализация.
