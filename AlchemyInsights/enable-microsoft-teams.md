...
Ако вече имате Microsoft Teams и трябва да знаете как да го конфигурирате и управлявате, вижте [Управление на Microsoft Teams настройки за вашата организация](https://docs.microsoft.com/MicrosoftTeams/enable-features-office-365).
