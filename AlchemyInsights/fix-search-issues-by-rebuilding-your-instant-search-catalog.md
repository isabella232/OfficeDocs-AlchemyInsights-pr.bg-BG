...
Ако срещате проблеми с търсене в Outlook, вижте връзките по-долу за помощ за отстраняване на неизправности.
...
- [Папките за търсене показват неочаквани PersonMetadata елементи с без тема](https://support.microsoft.com/help/4035436/outlook-search-folders-show-items-with-blank-subject)