...
ms.locfileid: "50708231"
---
# <a name="restore-deleted-files-or-folders-in-sharepoint"></a>Възстановяване на изтрити файлове или папки в SharePoint

Ако случайно изтриете файл или папка в SharePoint, е възможно да можете да го възстановите по-късно от кошчето.
...
Ако много от вашите файлове на SharePoint бъдат изтрити, презаписани, повредени или заразени от злонамерен софтуер, можете да възстановите цялата библиотека на SharePoint в предишен час.
