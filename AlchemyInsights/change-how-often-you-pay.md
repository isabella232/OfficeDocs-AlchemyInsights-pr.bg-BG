...
За да промените колко често сте таксувани и да плащате за абонамент, изпълнете следните стъпки в центъра за администриране на Microsoft 365.
...
3. На страницата по-подробно за абонамента, в секцията **абонаменти и настройки за плащане** изберете **Редактиране на честота на фактуриране**.
4. В екрана **Редактиране на честота на фактуриране** изберете опцията за това колко често искате да бъдете таксувани, след което щракнете върху **Промяна**.

**Забележка**: ежемесечните или годишните фактури са само опции.
