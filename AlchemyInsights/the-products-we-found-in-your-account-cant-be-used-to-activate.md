---
title: Office Съобщение - Продуктите, които намерихме в профила ви, не могат да се използват за активиране
ms.author: pebaum
author: pebaum
manager: mnirkhe
ms.audience: Admin
...
ms.locfileid: "44010538"
---
# <a name="fixing-the-office-apps-the-products-we-found-in-your-account-cant-be-used-to-activate-message"></a>Коригиране на office приложения "Продуктите, които намерихме в акаунта ви, не могат да се използват за активиране"
...
За сценарии за споделен компютър вижте [отстраняване на проблеми с активиране на споделен компютър за Приложения на Microsoft 365 за предприятие](https://docs.microsoft.com/deployoffice/troubleshoot-shared-computer-activation).
