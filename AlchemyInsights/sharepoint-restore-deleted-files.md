...
За действия с групово Кошче администраторите могат да помислят за използване на [PnP на SharePoint online](https://docs.microsoft.com/powershell/sharepoint/sharepoint-pnp/sharepoint-pnp-cmdlets?view=sharepoint-ps).
