...
1. Ако DEP устройство не е в състояние да се запишат и е разрешен МВРХ (удостоверяване), забранете МВНР. В момента МВНР не се поддържа за DEP записване
...
3. Преглед на тези документи за списък на често срещани грешки, които пречат на записване и резолюции на всеки: [ръководство за отстраняване на проблеми](https://support.microsoft.com/en-us/help/4039809/troubleshooting-ios-device-enrollment-in-intune) и [отстраняване на doc](https://docs.microsoft.com/en-us/intune-classic/troubleshoot/troubleshoot-device-enrollment-in-intune)
    
4. [Научете повече за устройство за записване на програма](https://docs.microsoft.com/en-us/intune/device-enrollment-program-enroll-ios).
