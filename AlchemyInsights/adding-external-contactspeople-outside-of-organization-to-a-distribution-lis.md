...
Ако искате външните потребители да могат да изпращат съобщения до групата за разпространение, проверете дали групата е конфигурирана да приема поща от външни податели. За повече информация вижте [управление на доставката](https://technet.microsoft.com/library/bb124513.aspx#deliverymanagement).
