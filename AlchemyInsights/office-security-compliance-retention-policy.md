...
- Отидете на сигурност и съответствие > управление на данни > задържане
  - Вижте [тази](https://docs.microsoft.com/office365/securitycompliance/retention-policies) статия

- Отидете на защита и съответствие > откриване на откриването> Разширено откриване на 
  - Вижте [тази](https://docs.microsoft.com/office365/securitycompliance/ediscovery-cases) статия

- Отидете на сигурност и съответствие > класификации > задържане
  - Вижте тези статии
