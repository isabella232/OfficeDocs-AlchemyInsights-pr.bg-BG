...
- Има два начина за изпращане на автоматични отговори "извън офиса" в зависимост от типа на вашия имейл акаунт.
- Щракнете върху **файл**, след което изберете **автоматични отговори** на базата на вашата версия на Outlook.
