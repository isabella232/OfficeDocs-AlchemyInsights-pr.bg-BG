...
---
# <a name="tips-about-recalling-messages"></a>Съвети за отказване на съобщения

Ето кога можете и как да не изтегляте съобщения:

* Като администратор можете да оттегляте съобщения от името на потребителите с помощта на PowerShell. Не можете да оттегляте съобщения от центъра за администриране.
