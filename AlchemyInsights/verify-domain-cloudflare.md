---
title: Проверете домейна си с Cloudflare
ms.author: pebaum
author: pebaum
manager: mnirkhe
ms.audience: Admin
...
ms.locfileid: "43766302"
---
# <a name="verify-your-domain-with-cloudflare"></a>Проверете домейна си с Cloudflare
...
Вижте [Създаване на DNS записи в Cloudflare за Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-cloudflare) за инструкции стъпка по стъпка.