---
title: Проблем с активирането – Акаунтът не разрешава редактиране на Mac
ms.author: pebaum
author: pebaum
manager: mnirkhe
ms.audience: Admin
...
ms.locfileid: "44510093"
---
# <a name="fixing-the-office-apps-your-account-doesnt-allow-editing-on-a-mac-message"></a>Коригиране на office приложения "вашият акаунт не позволява редактиране на Mac" съобщение
