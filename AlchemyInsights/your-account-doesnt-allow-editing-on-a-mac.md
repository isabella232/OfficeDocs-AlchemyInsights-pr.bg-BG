...
---
# <a name="fixing-the-microsoft-365-apps-your-account-doesnt-allow-editing-on-a-mac-message"></a>Поправяне на приложенията на Microsoft 365 "Вашият акаунт не разрешава редактиране на Mac" съобщение
