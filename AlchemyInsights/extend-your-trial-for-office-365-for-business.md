...
Можете да удължите безплатния пробен период за още един 30-дневен период. След това вашият процес преминава в 30-дневен [гратисен период](https://docs.microsoft.com/alchemyinsights/grace-period-for-microsoft-365-free-trial). За да разширите пробната си версия, изпълнете следните стъпки:
