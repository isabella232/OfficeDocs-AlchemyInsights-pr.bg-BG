...
---
# <a name="reactivate-a-microsoft-365-subscription"></a>Повторно активиране на абонамент за Microsoft 365
...
2. Изберете абонамента, който искате да активирате отново. В секцията Фактуриране изберете **Повторно активиране**.

    Ако не виждате **Повторно активиране** като налично действие, [извикайте поддръжка,](https://docs.microsoft.com/microsoft-365/admin/contact-support-for-business-products) за да активирате повторно абонамента си.
