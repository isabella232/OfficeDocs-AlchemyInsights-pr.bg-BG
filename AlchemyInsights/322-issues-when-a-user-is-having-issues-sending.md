...
ms.locfileid: "29458009"
---
# <a name="a-user-is-having-issues-sending-email-messages"></a><span data-ttu-id="bc222-102">Потребителят е като проблеми, изпращане на имейл съобщения</span><span class="sxs-lookup"><span data-stu-id="bc222-102">A user is having issues sending email messages</span></span>

<span data-ttu-id="bc222-p101">Тя изглежда като имате поща поток въпрос. Ние имаме за диагностика, който ще помогне за идентифициране много общи проблеми за потока на поща. Щракнете върху **изпълни диагностика** по-долу.</span><span class="sxs-lookup"><span data-stu-id="bc222-p101">It looks like you have a mail flow issue. We have diagnostics that will help identify many common mail flow problems. Click **Run Diagnostics** below.</span></span> 
