...
---
# <a name="error-there-was-a-problem-checking-this-devices-license-status"></a>Грешка: Възникна проблем при проверката на състоянието на лиценза на това устройство
