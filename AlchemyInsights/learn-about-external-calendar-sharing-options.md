...
---
# <a name="learn-about-external-calendar-sharing-options"></a>Научете за опциите за споделяне на външни календари

Ако трябва да планирате срещи с хора извън вашата организация, Office 365 ви позволява да направите календарите си достъпни за "външни потребители", които трябва да виждат времето за заетост, но нямат потребителски акаунти за вашата Office 365 среда. За повече информация вижте [споделяне на календари с външни потребители](https://docs.microsoft.com/office365/admin/manage/share-calendars-with-external-users).
