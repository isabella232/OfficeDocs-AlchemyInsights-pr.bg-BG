...
---
# <a name="install-skype-for-business"></a><span data-ttu-id="73496-102">Инсталиране на скайп за бизнес</span><span class="sxs-lookup"><span data-stu-id="73496-102">Install Skype for Business</span></span>

<span data-ttu-id="73496-103">Можете да инсталирате Skype за бизнес като следвате стъпките в тази статия: [Инсталиране Skype за бизнес](https://support.office.com/article/Install-Skype-for-Business-8a0d4da8-9d58-44f9-9759-5c8f340cb3fb.aspx)</span><span class="sxs-lookup"><span data-stu-id="73496-103">You can install Skype for Business by following the steps in this article: [Install Skype for Business](https://support.office.com/article/Install-Skype-for-Business-8a0d4da8-9d58-44f9-9759-5c8f340cb3fb.aspx)</span></span>
