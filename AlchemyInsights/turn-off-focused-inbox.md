...
---
# <a name="turn-off-focused-inbox"></a>Изключване на фокусираната входяща кутия

1. Изберете **Настройка** \> **фокусирана входяща кутия**.  

2. Под **Когато имейлът е получен,** изберете **Не сортирай съобщения**.
