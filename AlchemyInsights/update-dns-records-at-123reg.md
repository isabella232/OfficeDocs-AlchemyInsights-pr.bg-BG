...
---
# <a name="update-dns-records-at-123-reg"></a>Актуализиране на DNS записите в 123-reg

Използвайте връзките по-долу, за да помогнете за актуализирането на вашите DNS записи

- [Създаване на DNS записи в 123-reg.co.uk](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-123-reg-co-uk?view=o365-worldwide)
