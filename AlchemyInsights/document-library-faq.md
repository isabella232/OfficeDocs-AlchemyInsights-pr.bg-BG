...
Отидете на [SharePoint Online за отстраняване на неизправности](https://docs.microsoft.com/sharepoint/troubleshoot/online) и "Филтриране по заглавие" или ръчно детайлизиране на статии в раздела "Списъци и библиотеки".
...
- [Настройване на библиотека, която да изисква извличане на файлове](https://support.microsoft.com/en-us/office/set-up-a-library-to-require-check-out-of-files-0c73792b-f727-4e19-a1f9-3173899e695b)
...
- [Въведение в управлявани метаданни](https://docs.microsoft.com/sharepoint/managed-metadata)
