---
title: Тестване на вградени изображения на алхимията
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "44505044"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="6f764-102">Достъп до страницата за домейни</span><span class="sxs-lookup"><span data-stu-id="6f764-102">Access the Domains Page</span></span>

<span data-ttu-id="6f764-103">За да получите достъп до страницата с домейни, просто кликнете върху тази икона по-долу:</span><span class="sxs-lookup"><span data-stu-id="6f764-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="6f764-104">След това можете да добавяте, променяте или премахвате домейна си.</span><span class="sxs-lookup"><span data-stu-id="6f764-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="6f764-105">За повече информация вижте Често задавани въпроси за [домейни.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="6f764-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
