...
ms.locfileid: "36507152"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="f0a22-102">Достъп до страницата "домейни"</span><span class="sxs-lookup"><span data-stu-id="f0a22-102">Access the Domains Page</span></span>

<span data-ttu-id="f0a22-103">За достъп до страницата "домейни", щракнете върху тази икона по-долу:</span><span class="sxs-lookup"><span data-stu-id="f0a22-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="f0a22-104">След това можете да добавите, промяна или премахване на вашия домейн.</span><span class="sxs-lookup"><span data-stu-id="f0a22-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="f0a22-105">За повече информация, вижте [домейни FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span><span class="sxs-lookup"><span data-stu-id="f0a22-105">For more information, see the [Domains FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span></span>
