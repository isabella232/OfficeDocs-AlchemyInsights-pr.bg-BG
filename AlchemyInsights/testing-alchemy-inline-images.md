---
title: Тестване на вградени изображения в Alchemy
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "43759969"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="24ea0-102">Достъп до страницата на домейни</span><span class="sxs-lookup"><span data-stu-id="24ea0-102">Access the Domains Page</span></span>

<span data-ttu-id="24ea0-103">За да отворите страницата на домейните, просто щракнете върху тази икона по-долу:</span><span class="sxs-lookup"><span data-stu-id="24ea0-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="24ea0-104">След това можете да добавяте, променяте или премахвате домейна си.</span><span class="sxs-lookup"><span data-stu-id="24ea0-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="24ea0-105">За повече информация вижте [чзв.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="24ea0-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
