...
---
# <a name="access-the-domains-page"></a>Достъп до страницата на домейни

За да отворите страницата на домейните, просто щракнете върху тази икона по-долу:
...
За повече информация вижте [чзв.](https://docs.microsoft.com/office365/admin/setup/domains-faq)
