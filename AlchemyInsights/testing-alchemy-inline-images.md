---
title: Тестване на вградените изображения от "Алхимия"
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="8f864-102">Достъп до страницата "домейни"</span><span class="sxs-lookup"><span data-stu-id="8f864-102">Access the Domains Page</span></span>

<span data-ttu-id="8f864-103">За да получите достъп до страницата "домейни", просто щракнете върху тази икона по-долу:</span><span class="sxs-lookup"><span data-stu-id="8f864-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="8f864-104">След това можете да добавите, промените или премахнете вашия домейн.</span><span class="sxs-lookup"><span data-stu-id="8f864-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="8f864-105">За повече информация вижте ЧЗВ за [домейни.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="8f864-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
