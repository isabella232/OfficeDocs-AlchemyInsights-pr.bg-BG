...
---
# <a name="access-the-domains-page"></a>Достъп до страницата за домейни

За да получите достъп до страницата с домейни, просто кликнете върху тази икона по-долу:
...
След това можете да добавяте, променяте или премахвате домейна си.
За повече информация вижте Често задавани въпроси за [домейни.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)
