...
---
# <a name="how-to-stop-signing-in-automatically"></a>Как да престанете да влизате автоматично

За да спрете автоматичното влизане в Outlook.com, изчистете отметката от квадратчето за **искам да остана влязъл** на страницата, където въвеждате паролата си.
