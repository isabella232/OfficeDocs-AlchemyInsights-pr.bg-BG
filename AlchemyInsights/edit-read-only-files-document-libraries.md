...
- Ако вие предпочитате да има документи, отворени за редактиране в Office, когато щракнете върху заглавието, можете да зададете до библиотеката да направи това (толкова дълго, колкото имате разрешение да променяте настройките на библиотеката).
