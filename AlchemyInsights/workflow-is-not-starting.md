...
- SharePoint 2010 работни потоци, които бавят Старт.
    ...
    Също така ако хронологията на работния поток е нараснал големи, може да искате да прочисти елементи или да създадете нов списък с хронологии.
...
Искате ли да опитате Micrsoft поток в SharePoint Online?
