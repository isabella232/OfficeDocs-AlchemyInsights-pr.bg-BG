...
3. Изберете трите точки (още действия), след което изберете **Повторно активиране на този абонамент**.
    ...
    **Важно:** Ако не виждате Повторно активиране **на този абонамент** като налично действие, обадете се на [поддръжката,](https://go.microsoft.com/fwlink/p/?linkid=518322) за да активирате отново абонамента си.
