...
- Изчистете всички предишни следи от Office и преинсталирайте с помощта на помощника за поддръжка и възстановяване (SaRA). 
    ...
    - Използвайте SaRA, за да [преинсталирате Office](http://aka.ms/sara-officeinstall). **Забележка**: за настройване на Visio или Project чрез SaRA използвайте [Инсталиране на Visio](https://aka.ms/SaRA-VisioSetupScenario) или [Инсталиране на Project](https://aka.ms/SaRA-ProjectSetupScenario).  
