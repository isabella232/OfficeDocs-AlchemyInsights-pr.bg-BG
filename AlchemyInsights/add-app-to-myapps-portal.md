...
---
# <a name="adding-applications-to-the-myapps-portal"></a>Добавяне на приложения към портала на моите приложения

Ако вашият администратор ви е дал разрешение, можете да добавите ново приложение към страницата с **приложения** . За повече информация вижте [Добавяне на ново приложение в портала "моите приложения](https://docs.microsoft.com/azure/active-directory/user-help/my-apps-portal-end-user-access#add-a-new-app-to-the-my-apps-portal)".