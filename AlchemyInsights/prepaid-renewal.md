...
2. Намерете абонамент, който искате да се разшири. В раздела **Фактуриране** изберете **Extend крайна дата**.

3. В прозореца **Extend абонамент** **използването на нови и неизползвани продуктов ключ**изберете **напред**.
