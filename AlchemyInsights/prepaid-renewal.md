...
2. Намерете абонамента, който искате да удължите. В секцията **Таксуване** изберете **Удължена крайна дата**.

3. В екрана Разширяване на **абонамента** изберете **Използване на нов и неизползван продуктов ключ**, след което изберете **Напред**.
