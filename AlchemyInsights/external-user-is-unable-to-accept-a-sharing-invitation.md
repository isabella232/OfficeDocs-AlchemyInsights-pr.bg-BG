...
---
# <a name="external-user-is-unable-to-accept-a-sharing-invitation"></a>Външният потребител не може да приеме покана за споделяне

Ако външен потребител не може да приеме покана за споделяне на SharePoint или OneDrive, моля, опитайте да посетите връзките по-долу: 
