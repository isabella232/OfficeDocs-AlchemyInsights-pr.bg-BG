...
ms.locfileid: "49984504"
---
# <a name="issues-with-microsoft-applications"></a>Проблеми с приложенията на Microsoft

Проблеми, които са свързани с влизането в приложенията на Microsoft:
...
- [Не мога да вляза в приложение на Microsoft](https://docs.microsoft.com/azure/active-directory/application-sign-in-problem-first-party-microsoft/?WT.mc_id=UI_AAD_Apps_Sign_In_Support_L2_MicrosoftApp)
