...
Ако искате хората във вашата организация, за да можете да влизате и използвате SharePoint и OneDrive, трябва да добавите акаунта за тях и се уверете, че те имат лиценз, който им дава достъп до SharePoint и OneDrive. Най-лесният начин за добавяне на потребители е в центъра за администрация на Office 365.
  
1. Отидете на [страницата на активните потребители в центъра за администрация на Office 365](https://portal.office.com/adminportal/home#/users)а след това щракнете върху **Добави потребителя**.
