...
3. В **Редактиране на детайлите** се появява муха, че, проверете дали **позволявам хора извън моята организация да изпраща имейл до тази дистрибуция група.** е **на**и след това щракнете върху **Запиши**.
