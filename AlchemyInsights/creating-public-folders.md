...
След като пощенска кутия е бил създаден, можете да започнете да създавате отделни папки или да кажете на вашите потребители да [започнете създаване и използване на публични папки в Outlook](https://support.office.com/article/Create-and-share-a-public-folder-in-Outlook-a2835011-d524-4a5c-a207-05c159bb2a97). Като администратор можете да [създавате публични папки за вашата организация](https://technet.microsoft.com/library/bb691104%28v=exchg.150%29.aspx).
