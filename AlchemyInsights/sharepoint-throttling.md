...
- [SharePoint онлайн и OneDrive миграция скорост](https://docs.microsoft.com/sharepointmigration/sharepoint-online-and-onedrive-migration-speed)
 ...
 - [Дръжка SharePoint Online задушавам с помощта на експоненциална отстъпи](https://docs.microsoft.com/sharepoint/dev/solution-guidance/handle-sharepoint-online-throttling-by-using-exponential-back-off)

- [Капацитет за планиране и натоварване тестване SharePoint Online](https://support.office.com/article/Capacity-planning-and-load-testing-SharePoint-Online-c932bd9b-fb9a-47ab-a330-6979d03688c0)
