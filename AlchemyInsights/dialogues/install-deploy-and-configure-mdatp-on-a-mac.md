...
ms.locfileid: "50692822"
---
# <a name="install-deploy-and-configure-mdatp-on-a-mac"></a>Инсталиране, разполагане и конфигуриране на MDATP на Mac

Можете да разположите MDATP [ръчно](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/mac-install-manually) или като използвате инструмент за управление:

- [Настройване на Microsoft](https://go.microsoft.com/fwlink/?linkid=2144548)
...
За да научите повече, вижте [как да инсталирате MDATP за Mac](https://go.microsoft.com/fwlink/?linkid=2144672)
