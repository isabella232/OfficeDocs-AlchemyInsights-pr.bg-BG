...
1. Изберете **Да започнете** , ако това е вашият първи път настройвате имейл на мобилния апартамент. В противен случай, натиснете **меню** и след това натиснете **Настройки** \> **Добавяне на акаунт** \> **Добавяне на имейл акаунт**.
