...
---
# <a name="troubleshoot-issues-with-enrolling-macos-devices-in-microsoft-intune"></a>Отстраняване на проблеми със записване macOS устройства в Microsoft Intune
...
3. [Научете как да се запишат macOS устройства в Microsoft Intune](https://docs.microsoft.com/intune/macos-enroll).
    
[Вижте крайния потребител ръководство за записване macOS устройство в Microsoft Intune](https://docs.microsoft.com/intune-user-help/enroll-your-device-in-intune-macos-cp)
